...
joblib.dump(clf, 'gujaratFiles/randomForest.pkl')

clf_pred = clf.predict(X_test)

print("R2 score of test:", r2_score(y_test, clf_pred))

np.save('gujaratFiles/randomForestPred.npy', clf_pred)
...
joblib.dump(rf_random, 'gujaratFiles/randomForestRandomized.pkl')
...
np.save('gujaratFiles/randomForestRandomizedPred.npy', pred)
...
joblib.dump(reg, 'gujaratFiles/extraTree.pkl')

pred = reg.predict(X_test)
print("R2 score of test:", r2_score(y_test, pred))

np.save('gujaratFiles/extraTreePred.npy', pred)
...
joblib.dump(xt_random, 'gujaratFiles/extraTreeRandomized.pkl')
...
np.save('gujaratFiles/extraTreeRandomizedPred.npy', pred)
...
joblib.dump(xgb_r, 'gujaratFiles/xgboost.pkl')

pred = xgb_r.predict(X_test)
print("R2 score of test:", r2_score(y_test, pred))

np.save('gujaratFiles/xgboostPred.npy', pred)
...
joblib.dump(clf, 'gujaratFiles/xgboostRandomized.pkl')
...
np.save('gujaratFiles/xgboostRandomizedPred.npy', pred)
...
joblib.dump(model, 'gujaratFiles/lightGBM.pkl')

predicted_y = model.predict(X_test)
print("R2 score of test:", r2_score(y_test, predicted_y))

np.save('gujaratFiles/lightGBMPred.npy', predicted_y)
...
joblib.dump(model, 'gujaratFiles/lightGBMRandomized.pkl')
...
np.save('gujaratFiles/lightGBMRandomizedPred.npy', predicted_y)
